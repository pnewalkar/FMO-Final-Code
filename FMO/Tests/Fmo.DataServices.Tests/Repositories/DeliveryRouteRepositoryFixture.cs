...
namespace Fmo.DataServices.Tests.Repositories
{
    ...
    public class DeliveryRouteRepositoryFixture : RepositoryFixtureBase
    {
        ...
        protected void SetUpNew()
        {
            ...
            mockFmoDbContext.Setup(x => x.Set<DeliveryRouteBlock>()).Returns(mockDeliveryRouteBlockDBSet.Object);
            mockFmoDbContext.Setup(x => x.DeliveryRouteBlocks).Returns(mockDeliveryRouteBlockDBSet.Object);
            mockFmoDbContext.Setup(c => c.DeliveryRouteBlocks.AsNoTracking()).Returns(mockDeliveryRouteBlockDBSet.Object);
            ...
            mockFmoDbContext.Setup(x => x.Set<Block>()).Returns(mockBlockDBSet.Object);
            mockFmoDbContext.Setup(x => x.Blocks).Returns(mockBlockDBSet.Object);
            mockFmoDbContext.Setup(c => c.Blocks.AsNoTracking()).Returns(mockBlockDBSet.Object);
            ...
            mockFmoDbContext.Setup(x => x.Set<BlockSequence>()).Returns(mockBlockSequenceDBSet.Object);
            mockFmoDbContext.Setup(x => x.BlockSequences).Returns(mockBlockSequenceDBSet.Object);
            mockFmoDbContext.Setup(c => c.BlockSequences.AsNoTracking()).Returns(mockBlockSequenceDBSet.Object);
            ...
            mockFmoDbContext.Setup(c => c.DeliveryPoints.AsNoTracking()).Returns(mockDeliveryPointDBSet.Object);
            ...
            mockFmoDbContext.Setup(x => x.Set<DeliveryPointAlias>()).Returns(mockDeliveryPointAliasDBSet.Object);
            mockFmoDbContext.Setup(x => x.DeliveryPointAlias).Returns(mockDeliveryPointAliasDBSet.Object);
            mockFmoDbContext.Setup(c => c.DeliveryPointAlias.AsNoTracking()).Returns(mockDeliveryPointAliasDBSet.Object);
            ...
            mockFmoDbContext.Setup(c => c.PostalAddresses.AsNoTracking()).Returns(mockPostalAddressDBSet.Object);
            ...
            mockFmoDbContext.Setup(x => x.Set<Postcode>()).Returns(mockPostcodeDBSet.Object);
            mockFmoDbContext.Setup(x => x.Postcodes).Returns(mockPostcodeDBSet.Object);
            mockFmoDbContext.Setup(c => c.Postcodes.AsNoTracking()).Returns(mockPostcodeDBSet.Object);
