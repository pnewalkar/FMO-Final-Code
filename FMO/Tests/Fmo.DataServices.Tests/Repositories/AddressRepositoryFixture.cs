...
namespace Fmo.DataServices.Tests.Repositories
{
    ...
    public class AddressRepositoryFixture : RepositoryFixtureBase
    {
        ...
        public void Test_CreateAddressAndDeliveryPoint_SamePostcode()
        {
            ...
            Guid results = testCandidate.CreateAddressAndDeliveryPoint(addDeliveryPointDTO2);
            Assert.NotNull(results);
            Assert.IsTrue(results != Guid.Empty);
        }
        ...
        {
            SetUpDataForCreateAddressAndDeliveryPoint();
            Guid results = testCandidate.CreateAddressAndDeliveryPoint(addDeliveryPointDTO1);
            Assert.NotNull(results);
            Assert.IsTrue(results != Guid.Empty);
        }
        ...
        {
            SetUpDataForCreateAddressAndDeliveryPoint();
            Guid results = testCandidate.CreateAddressAndDeliveryPoint(addDeliveryPointDTO3);
            Assert.NotNull(results);
            Assert.IsTrue(results == Guid.Empty);
        }
