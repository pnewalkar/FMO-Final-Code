namespace Fmo.DataServices.Tests.Repositories
{
    ...
    public class UnitLocationRepositoryFixture : RepositoryFixtureBase
    {
        ...
        protected override void OnSetup()
        {
            ...
            mockFmoDbContext.Setup(x => x.UnitLocations.AsNoTracking()).Returns(mockDeliveryUnitLocationDbSet.Object);
            ...
            mockFmoDbContext.Setup(x => x.Set<PostalAddress>()).Returns(mockPostalAddressesDbSet.Object);
            mockFmoDbContext.Setup(x => x.PostalAddresses).Returns(mockPostalAddressesDbSet.Object);
            mockFmoDbContext.Setup(x => x.PostalAddresses.AsNoTracking()).Returns(mockPostalAddressesDbSet.Object);
            ...
            mockFmoDbContext.Setup(x => x.Set<Postcode>()).Returns(mockPostCodesDbSet.Object);
            mockFmoDbContext.Setup(x => x.Postcodes).Returns(mockPostCodesDbSet.Object);
            mockFmoDbContext.Setup(x => x.Postcodes.AsNoTracking()).Returns(mockPostCodesDbSet.Object);
            ...
            mockFmoDbContext.Setup(x => x.Set<PostcodeSector>()).Returns(mockPostcodeSectorDbSet.Object);
            mockFmoDbContext.Setup(x => x.PostcodeSectors).Returns(mockPostcodeSectorDbSet.Object);
            mockFmoDbContext.Setup(x => x.PostcodeSectors.AsNoTracking()).Returns(mockPostcodeSectorDbSet.Object);
            ...
            mockFmoDbContext.Setup(x => x.Set<PostcodeDistrict>()).Returns(mockPostcodeDistrictDbSet.Object);
            mockFmoDbContext.Setup(x => x.PostcodeDistricts).Returns(mockPostcodeDistrictDbSet.Object);
            mockFmoDbContext.Setup(x => x.PostcodeDistricts.AsNoTracking()).Returns(mockPostcodeDistrictDbSet.Object);
            ...
            mockFmoDbContext.Setup(x => x.Set<PostcodeArea>()).Returns(mockPostcodeAreasDbSet.Object);
            mockFmoDbContext.Setup(x => x.PostcodeAreas).Returns(mockPostcodeAreasDbSet.Object);
            mockFmoDbContext.Setup(x => x.PostcodeAreas.AsNoTracking()).Returns(mockPostcodeAreasDbSet.Object);

            var mockUserRoleUnitDbSet = MockDbSet(userRoleUnits);
            mockFmoDbContext.Setup(x => x.Set<UserRoleUnit>()).Returns(mockUserRoleUnitDbSet.Object);
            mockFmoDbContext.Setup(x => x.UserRoleUnits).Returns(mockUserRoleUnitDbSet.Object);
            mockFmoDbContext.Setup(x => x.UserRoleUnits.AsNoTracking()).Returns(mockUserRoleUnitDbSet.Object);
