...
namespace Fmo.Common.Constants
{
    public class ErrorMessageConstants
    {
        ...
        public const string EntityNotFoundExceptionMessage = "The context or connection have been disposed.";
        public const string EntityNotFoundExceptionofTypeMessage = "The context or connection have been disposed.";
    }
}
