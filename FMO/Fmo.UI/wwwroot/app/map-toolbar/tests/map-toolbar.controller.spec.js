describe('MapToolbar: Controller', function() {
    ...
    var MockMapToolbarService = {
        ...
        deselectButton: function() { return false }
    };
    ...
    describe('should be call method deselectButton', function()
    {
        it('should set $emit is true and a $emit emitter fired', function() {

            spyOn(MockMapToolbarService, 'deselectButton').and.returnValue(true);
            ...
            //Call to ctrl method with mockService function
            ctrl.deselectButton(name);
            MockMapToolbarService.deselectButton(name);
        ...
        it('should set $emit is false and a $emit emitter fired', function() {

            spyOn(MockMapToolbarService, 'deselectButton').and.returnValue(false);
            //expect(ctrl.selectedButton()).toBe('null');
