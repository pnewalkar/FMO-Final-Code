...
function MapStylesFactory() {
    ...
    function getRouteMaintenanceStyle(feature) {
        ...
        var blockId = feature.get != angular.isUndefined(undefined)  ? feature.getId() : feature;
    ...
    function blockStyle(feature) {
        ...
        var block = feature.get('block') != angular.isUndefined(undefined)  ? feature.get('block') : feature;
        if (block.deadhead) {
    ...
    function activeStyle(feature) {
        ...
        var type = feature.get != angular.isUndefined(undefined)  ? feature.get('type') : feature;
        switch (type) {
            case "pathlink":
            ...
            case "group":
                if (feature.get != angular.isUndefined(undefined) ) {
    ...
    function getGroupStyle(feature, selected, simGroup) {
        ...
        var groupType = feature.get != angular.isUndefined(undefined)  ? feature.get('groupType') : feature;
        if (simGroup) {
            var point = feature.get != angular.isUndefined(undefined)  ? feature.get('point') : feature;
