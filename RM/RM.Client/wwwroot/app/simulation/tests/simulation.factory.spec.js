describe('Simulation: Factory', function () {
    ...
    ///////////Load Module/////////////////
    beforeEach(module('simulation'));
    
    ////////////injecct to provider for Mocking ///////////////
    beforeEach(function(){
    ...
    /////////////////Inject to factory set up////////////////
   beforeEach(function(){
        angular.mock.inject(function (_simulationAPIService_,_$httpBackend_, _$q_,_GlobalSettings_,_stringFormatService_) {
...
/*    it('should be promise return response of getScenario method', function() {
        ...
        //Call to factory function
        simulationAPIService.getScenario(operationStateID, deliveryUnitID)
            .then(function(data) {
                response = data;
            });
...
/*    it('should handle error when promise reject getScenario method ', function() {
 ...
 /*   it('should be promise return response of getRoutes method', function() {
        ...
        //Call to factory function
        simulationAPIService.getRoutes(operationStateID, deliveryScenarioID)
            .then(function(data) {
                response = data;
            });
