...
describe('Simulation: Controller', function () {
    ...
    var mockReferenceDataConstants = { OperationalStatus: { 
        DBCategoryName: "Operational Status", AppCategoryName: "OperationalStatus", ReferenceDataNames: [] },
        SenarioOperationState: { 
        DBCategoryName: "Operational Status", AppCategoryName: "OperationalStatus", ReferenceDataNames: [] }      
    };
    ...
    it('should be return promise undefined when loadScenario called', function() {
    ...
    it('should be return promise response when cal loadDeliveryRoute', function() {
