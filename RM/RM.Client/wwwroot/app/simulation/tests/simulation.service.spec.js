...
describe('Simulation: Service', function () {
    ...
    var mockReferenceDataConstants = { SenarioOperationState: { DBCategoryName: "Operational Status", AppCategoryName: "OperationalStatus", ReferenceDataNames: [] }};
    ...
    beforeEach(function () {
        ...
        module(function ($provide) {
            ...
            $provide.factory('referencedataApiService', function ($q) {                
                function getSimpleListsReferenceData(referenceDataConstants) { }                
                return {
        ...
        inject(function (_$rootScope_,_simulationService_,_simulationAPIService_,_$q_,_referenceDataConstants_,_referencedataApiService_) {
    ...
    it('should promise to return a success response once loadRouteLogStatus method is called', function() {
        ...
        simulationService.loadRouteLogStatus();
    ...
    it('should promise to return a success response once loadScenario method is called', function() {
        ...
        spyOn(simulationAPIService,'getScenario').and.returnValue(deffer.promise);               
        
        simulationService.loadScenario("9c1e56d7-5397-4984-9cf0-cd9ee7093c88","b51aa229-c984-4ca6-9c12-510187b81050");
    ...
    it('should promise to return a success response once loadDeliveryRoute method is called', function() {
        ...
        spyOn(simulationAPIService,'getRoutes').and.returnValue(deffer.promise);               
        
        simulationService.loadDeliveryRoute("9c1e56d7-5397-4984-9cf0-cd9ee7093c88");
        
        deffer.resolve(loadDeliveryRouteMockData);
        $rootScope.$apply();

        expect(simulationAPIService.getRoutes).toHaveBeenCalledWith("9c1e56d7-5397-4984-9cf0-cd9ee7093c88");        
    }); 
