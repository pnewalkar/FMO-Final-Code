...
describe('Simulation: Service', function () {
    ...
    beforeEach(function () {
        ...
        angular.mock.inject(function (_$rootScope_,_simulationService_,_simulationAPIService_,_$q_,_referenceDataConstants_,_referencedataApiService_) {
    ...
    it('should be return promise response when call loadRouteLogStatus', function(done) {
        var RouteStatusObj = undefined;
        var selectedRouteStatusObj = undefined;
        var selectedDeliveryUnitObj = undefined;
         
        //Cal to Promise and return response
        simulationAPIService.getStatus(RouteStatusObj,selectedRouteStatusObj,selectedRouteStatusObj,selectedDeliveryUnitObj).then(function (response) {
            expect(response).toBeDefined();
            expect(response).toBe(loadRouteLogStatusMockData);
    ...
    it('should be return promise response when call loadScenario', function(done) {
        var selectedRouteStatusObj = "9c1e56d7-5397-4984-9cf0-cd9ee7093c88";
        var selectedDeliveryUnitObj = "b51aa229-c984-4ca6-9c12-510187b81050";
         
        //Cal to Promise and return response
        simulationAPIService.getScenario(selectedRouteStatusObj,selectedDeliveryUnitObj).then(function (response) {
            expect(response).toBeDefined();
            expect(response).toBe(loadScenarioMockData);
    ...
    it('should be return promise response when call loadDeliveryRoute', function(done) {
        ...
        simulationAPIService.getRoutes(operationStateID,deliveryScenarioID).then(function (response) {
            expect(response).toBeDefined();
            expect(response).toBe(loadDeliveryRouteMockData);
