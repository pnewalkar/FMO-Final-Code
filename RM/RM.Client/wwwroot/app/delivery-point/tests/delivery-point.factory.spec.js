'use strict';
describe('Delivery Point : Factory', function() {
    var $q;
    var defrred;
    var $httpBackend;
    var GlobalSettings;
   ...
   beforeEach(function(){
        ...
        inject(function (_$rootScope_,_deliveryPointAPIService_,_$httpBackend_, _$q_,_GlobalSettings_,_stringFormatService_) {
    ...
    it('should promise to return a success response once GetDeliveryPointsResultSet method is called', function() {
        var response;
        var expectedUrl = GlobalSettings.apiUrl+GlobalSettings.getDeliveryPointsResultSet;
    ...
    it('should promise to return a success response once GetAddressByPostCode method is called', function() {
        var response;
        var expectedUrl = GlobalSettings.apiUrl+GlobalSettings.getAddressByPostCode;
    ...
    it('should promise to return a success response once GetAddressLocation method is called', function() {
        var response; 
        var expectedUrl = GlobalSettings.apiUrl+GlobalSettings.getAddressLocation+'mumbai';        
    ...
    it('should promise to return a error response once GetAddressLocation method is called', function() {
        var response; 
        var expectedUrl = GlobalSettings.apiUrl+GlobalSettings.getAddressLocation+'mumbai';        
    ...
    it('should promise to return a success response once GetPostalAddressByGuid method is called', function() {
        var response;
        var expectedUrl = GlobalSettings.apiUrl+GlobalSettings.getPostalAddressByGuid;        
    ...
    it('should promise to return a error response once GetPostalAddressByGuid method is called', function() {
        var response; 
        var expectedUrl = GlobalSettings.apiUrl+GlobalSettings.getPostalAddressByGuid;
    ...
    it('should promise to return a success response once CreateDeliveryPoint method is called', function() {
        var response; 
        var expectedUrl = GlobalSettings.apiUrl+GlobalSettings.createDeliveryPoint;
    ...
    it('should promise to return a error response once CreateDeliveryPoint method is called', function() {
        var response;
        var expectedUrl = GlobalSettings.apiUrl+GlobalSettings.createDeliveryPoint;
    ...
    it('should promise to return a success response once UpdateDeliverypoint method is called', function() {
        var response;
        var expectedUrl = GlobalSettings.apiUrl+GlobalSettings.updateDeliveryPoint;
        var deliveryPointModelDTO = {result:"success"};   

        $httpBackend.when('PUT', expectedUrl, {result: "success"})
            .respond(200, {result:"success"});
    ...
    it('should promise to return a error response once UpdateDeliverypoint method is called', function() {
        var response;
        var expectedUrl = GlobalSettings.apiUrl+GlobalSettings.updateDeliveryPoint;
