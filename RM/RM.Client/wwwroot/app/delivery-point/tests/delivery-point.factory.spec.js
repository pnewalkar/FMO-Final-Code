...
describe('deliveryPoint: Factory', function () {
    ...
    var MockGlobalSettings = {
        ...
        getDeliveryPointsResultSet: "/address/SearchAddressdetails?searchText=",
        getAddressByPostCode: "/address/GetAddressByPostCode?selectedItem=",
        getAddressLocation: "/addresslocation/GetAddressLocationByUDPRN?udprn=",
        getPostalAddressByGuid: "/address/GetPostalAddressByGuid?addressGuid=",
        createDeliveryPoint: "/deliveryPoints/CreateDeliveryPoint/",
        updateDeliverypoint: "/deliveryPoints/UpdateDeliveryPoint/"
    };
   ...
   beforeEach(function(){
        ...
        inject(function (_$rootScope_,_deliveryPointAPIService_,_$httpBackend_, _$q_,_GlobalSettings_) {
   ...
   *@Promise check resolve
   */
    it('should be promise return response of GetDeliveryPointsResultSet method', function() {
        var response; 
        var expectedUrl = 'http://localhost:34583/api/address/SearchAddressdetails?searchText=mySearch';        

        //test $http with $httpBackend 
        $httpBackend.when('GET', expectedUrl)
            .respond(200, GetDeliveryPointsResultSetMockData);

        //Call to factory function
        deliveryPointAPIService.GetDeliveryPointsResultSet('mySearch')
            .then(function(data) {
                response = data;
            });

        //where no pending task perform should be flush the $httpBackend
        $httpBackend.flush();

        expect(response).toEqual(GetDeliveryPointsResultSetMockData);
    });

    /*
   *@Method - GetDeliveryPointsResultSet
   *@promise check with reject
   */
    it('should handle error when promise reject GetDeliveryPointsResultSet method ', function() {
        var response;
        var expectedUrl = 'http://localhost:34583/api/address/SearchAddressdetails?searchText=mySearch';        
        ...
        //catch the error when promise reject
        deliveryPointAPIService.GetDeliveryPointsResultSet('mySearch')
            .then(function(data) {
                response = data;
            }).catch(function() {
    ...
    /*
   *@Method - GetAddressByPostCode
   *@Promise check resolve
   */
    it('should be promise return response of GetAddressByPostCode method', function() {
        var response; 
        var expectedUrl = 'http://localhost:34583/api/address/GetAddressByPostCode?selectedItem=selectedItem';        

        //test $http with $httpBackend 
        $httpBackend.when('GET', expectedUrl)
            .respond(200, GetAddressByPostCodeMockData);

        //Call to factory function
        deliveryPointAPIService.GetAddressByPostCode('selectedItem')
            .then(function(data) {
                response = data;
            });
        ...
        expect(response).toEqual(GetAddressByPostCodeMockData);
    });
   ...
   *@promise check with reject
   */
    it('should handle error when promise reject GetAddressByPostCode method ', function() {
        var response;
        var expectedUrl = 'http://localhost:34583/api/address/GetAddressByPostCode?selectedItem=selectedItem';        
    ...
    /*
   *@Method - GetAddressLocation
   *@Promise check resolve
   */
    it('should be promise return response of GetAddressLocation method', function() {
        var response; 
        var expectedUrl = 'http://localhost:34583/api/addresslocation/GetAddressLocationByUDPRN?udprn=mumbai';        

        //test $http with $httpBackend 
        $httpBackend.when('GET', expectedUrl)
            .respond(200, GetAddressLocationMockData);

        //Call to factory function
        deliveryPointAPIService.GetAddressLocation('mumbai')
            .then(function(data) {
                response = data;
            });
        ...
        expect(response).toEqual(GetAddressLocationMockData);
    });
   ...
   *@promise check with reject
   */
    it('should handle error when promise reject GetAddressLocation method ', function() {
        var response;
        var expectedUrl = 'http://localhost:34583/api/addresslocation/GetAddressLocationByUDPRN?udprn=mumbai';        
     ...
     /*
   *@Method - GetPostalAddressByGuid
   *@Promise check resolve
   */
    it('should be promise return response of GetPostalAddressByGuid method', function() {
        var response; 
        var expectedUrl = 'http://localhost:34583/api/address/GetPostalAddressByGuid?addressGuid=1221';        

        //test $http with $httpBackend 
        $httpBackend.when('GET', expectedUrl)
            .respond(200, GetPostalAddressByGuidMockData);

        //Call to factory function
        deliveryPointAPIService.GetPostalAddressByGuid('1221')
            .then(function(data) {
                response = data;
            });
        ...
        expect(response).toEqual(GetPostalAddressByGuidMockData);
    });
   ...
   *@promise check with reject
   */
    it('should handle error when promise reject GetPostalAddressByGuid method ', function() {
        var response;
        var expectedUrl = 'http://localhost:34583/api/address/GetPostalAddressByGuid?addressGuid=1221';        
    ...
    /*
   *@Method - CreateDeliveryPoint
   *@Promise check resolve
   */
    it('should be promise return response of CreateDeliveryPoint method', function() {
        var response; 
        var expectedUrl = 'http://localhost:34583/api/deliveryPoints/CreateDeliveryPoint/';        
        var addDeliveryPointDTO = {result:"success"};   

        //Set Mocking Object data
        var MockObj = JSON.stringify({result: "success"});

        //test $http with $httpBackend 
        $httpBackend.when('POST', expectedUrl, MockObj)
            .respond(200, {result:"success"});

        //Call to factory function
        deliveryPointAPIService.CreateDeliveryPoint()
            .then(function(data) {
                response = data;
            });
        ...
        expect(response).toEqual(addDeliveryPointDTO);
    });
   ...
   *@promise check with reject
   */
    it('should handle error when promise reject CreateDeliveryPoint method ', function() {
        var response;
        var expectedUrl = 'http://localhost:34583/api/deliveryPoints/CreateDeliveryPoint/';        
    ...
    /*
   *@Method - UpdateDeliverypoint
   *@Promise check resolve
   */
    it('should be promise return response of UpdateDeliverypoint method', function() {
        var response; 
        var expectedUrl = 'http://localhost:34583/api/deliveryPoints/UpdateDeliveryPoint/';        
        var deliveryPointModelDTO = {result:"success"};   

        //Set Mocking Object data
        var MockObj = JSON.stringify({result: "success"});

        //test $http with $httpBackend 
        $httpBackend.when('PUT', expectedUrl, MockObj)
            .respond(200, {result:"success"});

        //Call to factory function
        deliveryPointAPIService.UpdateDeliverypoint()
            .then(function(data) {
                response = data;
            });
        ...
        expect(response).toEqual(deliveryPointModelDTO);
    });
   ...
   *@promise check with reject
   */
    it('should handle error when promise reject UpdateDeliverypoint method ', function() {
        var response;
        var expectedUrl = 'http://localhost:34583/api/deliveryPoints/UpdateDeliveryPoint/';        

        //test with real httpBackend 
        $httpBackend.when('PUT', expectedUrl)
            .respond(500);
