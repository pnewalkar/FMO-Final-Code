...
describe('Delivery Point : Factory', function() {
    ...
    var MockGlobalSettings = {
        ...
        getPostalAddressByGuid: "/postaladdressmanager/postaladdress/filter/addressguid:{0}",
        createDeliveryPoint: "/DeliveryPointManager/deliverypoint/newdeliverypoint",
        updateDeliverypoint: "/DeliveryPointManager/deliverypoint/"
    };
   ...
   beforeEach(function(){
        ...
        module(function ($provide) {
            $provide.constant('GlobalSettings', MockGlobalSettings);
            $provide.value('stringFormatService', MockStringFormatService);
        });

        inject(function (_$rootScope_,_deliveryPointAPIService_,_$httpBackend_,_GlobalSettings_,_stringFormatService_) {
    ...
    it('should promise to return a success response once GetAddressLocation method is called', function() {
        var expectedUrl = GlobalSettings.thirdPartyAddressLocationApiUrl + GlobalSettings.getAddressLocation+'mumbai';        
    ...
    it('should promise to return a success response once GetPostalAddressByGuid method is called', function() {
        var getPostalAddressByGuidParams = '/postaladdressmanager/postaladdress/filter/addressguid:1221';
        var expectedUrl = GlobalSettings.postalAddressApiUrl+getPostalAddressByGuidParams;        
    ...
    it('should promise to return a success response once CreateDeliveryPoint method is called', function() {
        var expectedUrl = GlobalSettings.deliveryPointApiUrl + GlobalSettings.createDeliveryPoint;
    ...
    it('should promise to return a success response once UpdateDeliverypoint method is called', function() {
        var expectedUrl = GlobalSettings.deliveryPointApiUrl + GlobalSettings.updateDeliverypoint;
