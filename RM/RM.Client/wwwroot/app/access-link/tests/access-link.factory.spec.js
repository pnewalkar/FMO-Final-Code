describe('accessLink: Factory', function () {
   ...
   /*
   *@Method - GetAdjPathLength
   *@Promise check resolve
   */
    it('should be promise return response of GetAdjPathLength method', function() {
        var response; 
        var expectedUrl = 'http://localhost:34583/api/accessLink/GetWorkloadLength/'; 
        var accessLinkManualCreateModelDTO = {result:"success"};   
        ...
        accessLinkAPIService.GetAdjPathLength(accessLinkManualCreateModelDTO)
            .then(function(data) {
                response = data;
            });
        ...
        expect(response).toEqual(accessLinkManualCreateModelDTO);
   ...
   */
    it('should handle error when promise reject GetAdjPathLength method ', function() {
        var response; 
        var expectedUrl = 'http://localhost:34583/api/accessLink/GetWorkloadLength/'; 
        var accessLinkManualCreateModelDTO = {result:"success"};   
   ...
   *@Promise check resolve
   */
    it('should be promise return response of CreateAccessLink method', function() {
        var response; 
        var expectedUrl = 'http://localhost:34583/api/accessLink/CreateManual/'; 
        var accessLinkDTOMockData = {result:"success"};   
        ...
        //Call to factory function
        accessLinkAPIService.CreateAccessLink(accessLinkDTOMockData)
            .then(function(data) {
                response = data;
            });
        ...
        expect(response).toEqual(accessLinkDTOMockData);
   ...
   *@promise check with reject
   */
    it('should handle error when promise reject CreateAccessLink method ', function() {
        var response; 
        var expectedUrl = 'http://localhost:34583/api/accessLink/CreateManual/'; 
        var accessLinkDTOMockData = {result:"success"};  
    ...
    /*
   *@Method - CheckAccessLinkIsValid
   *@Promise check resolve
   */
    it('should be promise return response of CreateAccessLink method', function() {
        var response; 
        var expectedUrl = 'http://localhost:34583/api/accessLink/CheckAccessLinkIsValid/'; 
        var accessLinkDTOMockData = {result:"success"};   
        ...
        //Call to factory function
        accessLinkAPIService.CheckAccessLinkIsValid(accessLinkDTOMockData)
            .then(function(data) {
                response = data;
            });
   ...
   *@promise check with reject
   */
    it('should handle error when promise reject CheckAccessLinkIsValid method ', function() {
        var response; 
        var expectedUrl = 'http://localhost:34583/api/accessLink/CheckAccessLinkIsValid/'; 
        var accessLinkDTOMockData = {result:"success"};  
