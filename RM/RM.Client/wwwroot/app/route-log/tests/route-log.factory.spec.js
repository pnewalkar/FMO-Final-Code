...
describe('Route-Log: Factory', function () {
   ...
   beforeEach(function(){
    ...
    it('should promise to return a success response once getRoutes method is called', function () {
        ...
        var getDeliveryRoutesParams = '/DeliveryRouteManager/deliveryroute/9c1e56d7-5397-4984-9cf0-cd9ee7093c88/DisplayText';
        var expectedUrl = GlobalSettings.deliveryRouteApiUrl+getDeliveryRoutesParams;

        $httpBackend.when('GET', expectedUrl)
            .respond(200, getRoutesMockData);

        routeLogAPIService.getRoutes("9c1e56d7-5397-4984-9cf0-cd9ee7093c88")
            .then(function(data) {
                response = data;
            });
