describe('Route-Log: Factory', function () {
    ...
    var MockGlobalSettings = {
	    ...
	    indexUrl: '',
        actionManagerApiUrl: "http://localhost:43423/api",
        referenceDataApiUrl: "http://localhost:26199/api",
        accessLinkApiUrl: "http://localhost:50237/api",
        deliveryPointApiUrl: "http://localhost:50236/api",
        deliveryRouteApiUrl: "http://localhost:50235/api",
        networkManagerApiUrl: "http://localhost:50242/api",
        postalAddressApiUrl: "http://localhost:43585/api",
        specialInstructionApiUrl: "http://localhost:50238/api",
        thirdPartyAddressLocationApiUrl: "http://localhost:50234/api",
        ...
        searchManagerApiUrl: "http://localhost:50243/api",
        indexUrl: "http://localhost:51978/app/index.html"
    ...
    //Load Module
    beforeEach(module('routeLog'));
    //beforeEach(module('FMOApp'));
   ...
   beforeEach(function(){
        angular.mock.inject(function (_routeLogAPIService_,_$httpBackend_, _$q_,_GlobalSettings_,_stringFormatService_) {
   ...
   */
   	it('should be promise return response of getSelectionType method', function() {
        var response; 
        var expectedUrl = 'http://localhost:34583/api/RouteLog/RouteLogsSelectionType';        
   ...
   */
    it('should handle error when promise reject getSelectionType method ', function() {
        var response;
        var expectedUrl = 'http://localhost:34583/api/RouteLog/RouteLogsSelectionType';        
   ...
   */
    it('should be promise return response of getStatus method', function() {
        ...
        var response; 
        var expectedUrl = 'http://localhost:34583/api/RouteLog/RouteLogsStatus';        
   ...
   */
    it('should be promise return response of getScenario method', function() {
        ...
        var response;
        /*
        *@ Method - getScenario("9c1e56d7-5397-4984-9cf0-cd9ee7093c88","b51aa229-c984-4ca6-9c12-510187b81050") pass the params
        *@ URL - "/UnitManager/scenario/{0}/{1}/ScenarioName,ID"
        **/
        //var expectedUrl = MockGlobalSettings.apiUrl+MockGlobalSettings.getDeliveryRouteScenario;     
        //var expectedUrl = 'http://localhost:34583/api/RouteLog/FetchDeliveryScenario?operationStateID={0}&deliveryUnitID={1}&fields=ScenarioName,ID';        
   ...
   */
    it('should be promise return response of getRoutes method', function() {
        ...
        var response;
        var expectedUrl = 'http://localhost:50235/api/DeliveryRouteManager/deliveryroute/9c1e56d7-5397-4984-9cf0-cd9ee7093c88/b51aa229-c984-4ca6-9c12-510187b81050';
        $httpBackend.when('GET', expectedUrl)
   ...
   */
    it('should handle error when promise reject getRoutes method ', function() {
        ...
        var expectedUrl = 'http://localhost:34583/api/DeliveryRouteManager/deliveryroute/9c1e56d7-5397-4984-9cf0-cd9ee7093c88/b51aa229-c984-4ca6-9c12-510187b81050';
        var response;
        //test with real httpBackend 
        $httpBackend.when('GET', expectedUrl)
            .respond(500);
     ...
     /*
   *@Method - getRouteDetailsByGUID
   *@Promise check resolve
   */
    it('should be promise return response of getRouteDetailsByGUID method', function() {
        
        var response;
        var expectedUrl = 'http://localhost:34583/api/DeliveryRouteManager/deliveryroute/routedetails/d8053df2-1aad-40c8-bbf6-de0ae783e772';
        $httpBackend.when('GET', expectedUrl)
            .respond(200, getRoutesMockData);

        //Call to factory function
        routeLogAPIService.getRouteDetailsByGUID("d8053df2-1aad-40c8-bbf6-de0ae783e772")
            .then(function(data) {
                response = data;
            });
   ...
   *@promise check with reject
   */
    it('should handle error when promise reject getRouteDetailsByGUID method ', function() {
