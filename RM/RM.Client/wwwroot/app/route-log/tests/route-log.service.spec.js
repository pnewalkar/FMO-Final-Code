describe('Route-Log: Service', function () {
    ...
    /////////////Mock data//////////////////////
    var getSelectionTypeMockData = [{"RouteselectionTypeObj":[{"id":"ffeb0dbc-d12b-e711-8735-28d244aef9ed","name":null,"value":"Single","displayText":null,"description":"Single"},{"id":"01ae2cc6-d12b-e711-8735-28d244aef9ed","name":null,"value":"Multiple","displayText":null,"description":"Multiple"}],"selectedRouteSelectionObj":{"id":"ffeb0dbc-d12b-e711-8735-28d244aef9ed","name":null,"value":"Single","displayText":null,"description":"Single"}}];
    ...
    beforeEach(function () {
        ...
        module(function ($provide) {
            $provide.factory('routeLogAPIService', function ($q) {
                function getSelectionType() {
                    deferred = $q.defer();
                    deferred.resolve(getSelectionTypeMockData);
                ...
                function getRoutes(operationStateID, deliveryScenarioID,selectionType) {
                    ...
                    {
                    	deferred.resolve(loadDeliveryRouteMockData_Multiple_Select);
                    } else {
                    	deferred.resolve(loadDeliveryRouteMockData_Single_Select);
                    }
                ...
                function getRouteDetailsByGUID() {
                    deferred = $q.defer();
                    deferred.resolve(getRouteDetailsByGUIDMockData);
                    return deferred.promise;
                }
                return {
         ...
         module(function ($provide) {
            $provide.factory('referenceDataConstants', function ($q) {                
                return '';
            });
        });
        ...
        inject(function (_$rootScope_,_routeLogAPIService_,_routeLogService_,_$q_,_$mdDialog_,_referencedataApiService_,_referenceDataConstants_,) {
    ...
    it('should be resolve promise when loadSelectionType have been called', function(done) {
    	
    	//this test has been done with asy call with done fun and should be expect data 
    	routeLogAPIService.getSelectionType().then(function(res) {
          expect(res).toBe(getSelectionTypeMockData);
          done();
        });
    ...
    it('should be initialize loadScenario and clearDeliveryRoute when selectedRouteStatus have been called', function() {

    	spyOn(routeLogService,'loadScenario');
    	routeLogService.loadScenario("9c1e56d7-5397-4984-9cf0-cd9ee7093c88","b51aa229-c984-4ca6-9c12-510187b81050");

    	expect(routeLogService.loadScenario).toHaveBeenCalledWith("9c1e56d7-5397-4984-9cf0-cd9ee7093c88","b51aa229-c984-4ca6-9c12-510187b81050");

    });

    it('should be resolve promise when loadRouteLogStatus have been called', function(done) {
    	
    	//this test has been done with asy call with done fun and should be expect data 
    	routeLogAPIService.getStatus().then(function(res) {
          expect(res).toBe(loadRouteLogStatusMockData);
          done();
        });
    ...
    it('should be delivery route disabled `true` when scenario selectionType is `Multiple`', function() {
    	
    	//spyOn(routeLogService,'scenarioChange').and.callThrough();
    	//routeLogService.scenarioChange('Multiple');

    	spyOn(routeLogService, 'scenarioChange').and.callFake(function(selectionType){
        	if(selectionType=="Multiple")
        	{
        		return {
    	...
    	routeLogService.scenarioChange("Multiple");
    	expect(routeLogService.scenarioChange).toHaveBeenCalledWith("Multiple");
    	expect(routeLogService.scenarioChange("Multiple")).toEqual({isDeliveryRouteDisabled: true,isShowMultiSelectionRoute: true});


    });

    it('should be delivery route disabled `false` when scenario selectionType is `Single`', function() {
    	...
    	routeLogService.scenarioChange("Single");
    	expect(routeLogService.scenarioChange).toHaveBeenCalledWith("Single");
    	expect(routeLogService.scenarioChange("Single")).toEqual({isDeliveryRouteDisabled: false,isShowMultiSelectionRoute: false});

    	
    });

    it('should be resolve promise when loadScenario have been called', function(done) {
    	
    	//this test has been done with asy call with done fun and should be expect data 
    	routeLogAPIService.getScenario("9c1e56d7-5397-4984-9cf0-cd9ee7093c88","b51aa229-c984-4ca6-9c12-510187b81050").then(function(res) {
          expect(res).toBe(loadScenarioMockData);
          done();
        });
    ...
    it('should be resolve promise when loadDeliveryRoute method call and selectionType is `Single`', function(done) {
    	
    	//this test has been done with asy call with done fun and should be expect data 
    	routeLogAPIService.getRoutes("9c1e56d7-5397-4984-9cf0-cd9ee7093c88","b51aa229-c984-4ca6-9c12-510187b81050","Single").then(function(res) {
          expect(res).toBe(loadDeliveryRouteMockData_Single_Select);
          done();
        });
    ...
    it('should be resolve promise when loadDeliveryRoute method call and selectionType is `Multiple`', function(done) {
    	//this test has been done with asy call with done fun and should be expect data 
    	routeLogAPIService.getRoutes("9c1e56d7-5397-4984-9cf0-cd9ee7093c88","b51aa229-c984-4ca6-9c12-510187b81050","Multiple").then(function(res) {
          expect(res).toBe(loadDeliveryRouteMockData_Multiple_Select);
          done();
        });
    ...
    it('should be resolve promise when deliveryRouteChange have been called', function(done) {
    	
    	//this test has been done with asy call with done fun and should be expect data 
    	routeLogAPIService.getRouteDetailsByGUID("d8053df2-1aad-40c8-bbf6-de0ae783e772").then(function(res) {
          expect(res).toBe(getRouteDetailsByGUIDMockData);
          done();
        });
