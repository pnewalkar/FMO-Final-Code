...
namespace RM.DataManagement.DeliveryPoint.WebAPI
{
 ...
 SqlServerTypes.Utilities.LoadNativeAssemblies( env.ContentRootPath);
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IDeliveryPointIntegrationService, DeliveryPointIntegrationService>();
            services.AddScoped<IDeliveryPointBusinessService, DeliveryPointBusinessService>();
