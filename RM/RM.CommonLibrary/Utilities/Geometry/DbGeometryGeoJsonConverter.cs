...
namespace RM.CommonLibrary.Utilities.Geometry
{
    public class DbGeometryGeoJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            ...
            else
            {
                ...
                {
                    throw new ArgumentException(
                    string.Format("Expecting DbGeography or DbGeometry, got {0}", value.GetType()), "value");
                }
            }
        ...
        private static object CreateDbGeo(JObject jsonObject, Type objectType)
        {
            ...
            {
                throw new ArgumentException(string.Format("Expected a DbGeography or DbGeometry objectType. Got {0}", objectType), "objectType");
            }
        ...
        public abstract class GeoBase
        {
            ...
            /// </summary>
            protected static ReadOnlyCollection<byte> PointXyWkbs = Array.AsReadOnly(BitConverter.GetBytes(PointWkb));

            /// <summary>
            /// The line-string well-known bytes descriptor.
            /// </summary>
            protected static ReadOnlyCollection<byte> LineStringXyWkbs = Array.AsReadOnly(BitConverter.GetBytes(LineStringWkb));

            /// <summary>
            /// The polygon well-known bytes descriptor.
            /// </summary>
            protected static ReadOnlyCollection<byte> PolygonXyWkbs = Array.AsReadOnly(BitConverter.GetBytes(PolygonWkb));

            /// <summary>
            /// The multi-point well-known bytes descriptor.
            /// </summary>
            protected static ReadOnlyCollection<byte> MultiPointXyWkbs = Array.AsReadOnly(BitConverter.GetBytes(MultiPointWkb));

            /// <summary>
            /// The multi-line-string well-known bytes descriptor.
            /// </summary>
            protected static ReadOnlyCollection<byte> MultiLineStringXyWkbs = Array.AsReadOnly(BitConverter.GetBytes(MultiLineStringWkb));

            /// <summary>
            /// The multi-polygon well-known bytes descriptor.
            /// </summary>
            protected static ReadOnlyCollection<byte> MultiPolygonXyWkbs = Array.AsReadOnly(BitConverter.GetBytes(MultiPolygonWkb));

            /// <summary>
            /// The collection well-known bytes descriptor.
            /// </summary>
            protected static ReadOnlyCollection<byte> GeometryCollectionXyWkbs = Array.AsReadOnly(BitConverter.GetBytes(GeometryCollectionWkb));

            /// <summary>
            /// The point well-known bytes descriptor.
            /// </summary>
            protected static ReadOnlyCollection<byte> PointXyzWkbs = Array.AsReadOnly(BitConverter.GetBytes(PointWkb + 1000));

            /// <summary>
            /// The line-string well-known bytes descriptor.
            /// </summary>
            protected static ReadOnlyCollection<byte> LineStringXyzWkbs = Array.AsReadOnly(BitConverter.GetBytes(LineStringWkb + 1000));

            /// <summary>
            /// The polygon well-known bytes descriptor.
            /// </summary>
            protected static ReadOnlyCollection<byte> PolygonXyzWkbs = Array.AsReadOnly(BitConverter.GetBytes(PolygonWkb + 1000));

            /// <summary>
            /// The multi-point well-known bytes descriptor.
            /// </summary>
            protected static ReadOnlyCollection<byte> MultiPointXyzWkbs = Array.AsReadOnly(BitConverter.GetBytes(MultiPointWkb + 1000));

            /// <summary>
            /// The multi-line-string well-known bytes descriptor.
            /// </summary>
            protected static ReadOnlyCollection<byte> MultiLineStringXyzWkbs = Array.AsReadOnly(BitConverter.GetBytes(MultiLineStringWkb + 1000));

            /// <summary>
            /// The multi-polygon well-known bytes descriptor.
            /// </summary>
            protected static ReadOnlyCollection<byte> MultiPolygonXyzWkbs = Array.AsReadOnly(BitConverter.GetBytes(MultiPolygonWkb + 1000));

            /// <summary>
            /// The collection well-known bytes descriptor.
            /// </summary>
            protected static ReadOnlyCollection<byte> GeometryCollectionXyzWkbs = Array.AsReadOnly(BitConverter.GetBytes(GeometryCollectionWkb + 1000));

            /// <summary>
            /// The point well-known bytes descriptor.
            /// </summary>
            protected static ReadOnlyCollection<byte> PointXyzmWkbs = Array.AsReadOnly(BitConverter.GetBytes(PointWkb + 3000));

            /// <summary>
            /// The line-string well-known bytes descriptor.
            /// </summary>
            protected static ReadOnlyCollection<byte> LineStringXyzmWkbs = Array.AsReadOnly(BitConverter.GetBytes(LineStringWkb + 3000));

            /// <summary>
            /// The polygon well-known bytes descriptor.
            /// </summary>
            protected static ReadOnlyCollection<byte> PolygonXyzmWkbs = Array.AsReadOnly(BitConverter.GetBytes(PolygonWkb + 3000));

            /// <summary>
            /// The multi-point well-known bytes descriptor.
            /// </summary>
            protected static ReadOnlyCollection<byte> MultiPointXyzmWkbs = Array.AsReadOnly(BitConverter.GetBytes(MultiPointWkb + 3000));

            /// <summary>
            /// The multi-line-string well-known bytes descriptor.
            /// </summary>
            protected static ReadOnlyCollection<byte> MultiLineStringXyzmWkbs = Array.AsReadOnly(BitConverter.GetBytes(MultiLineStringWkb + 3000));

            /// <summary>
            /// The multi-polygon well-known bytes descriptor.
            /// </summary>
            protected static ReadOnlyCollection<byte> MultiPolygonXyzmWkbs = Array.AsReadOnly(BitConverter.GetBytes(MultiPolygonWkb + 3000));

            /// <summary>
            /// The collection well-known bytes descriptor.
            /// </summary>
            protected static ReadOnlyCollection<byte> GeometryCollectionXyzmWkbs = Array.AsReadOnly(BitConverter.GetBytes(GeometryCollectionWkb + 3000));
        ...
        public class Point : GeoBase
        {
            ...
            public override void WellKnownBinary(Stream sout)
            {
                ...
                ? this.Position.P4.HasValue ? GeoBase.PointXyzmWkbs.ToArray() : GeoBase.PointXyzWkbs.ToArray()
                : GeoBase.PointXyWkbs.ToArray(),
                0,
                4);
        ...
        public class LineString : GeoBase
        {
            ...
            private byte[] Normalize()
            {
                if (this.Points.Any())
                {
                    ...
                    ? GeoBase.LineStringXyWkbs.ToArray()
                    : low == IndexesPerPoint.Three ? GeoBase.LineStringXyzWkbs.ToArray() : GeoBase.LineStringXyzmWkbs.ToArray();
                }

                return GeoBase.LineStringXyWkbs.ToArray();
            }
        }
        ...
        public class Polygon : GeoBase
        {
            ...
            private byte[] Normalize()
            {
                if (this.Rings.Any())
                {
                    ...
                    return low == IndexesPerPoint.Two
                    ? GeoBase.PolygonXyWkbs.ToArray()
                    : low == IndexesPerPoint.Three ? GeoBase.PolygonXyzWkbs.ToArray() : GeoBase.PolygonXyzmWkbs.ToArray();
                }

                return GeoBase.PolygonXyWkbs.ToArray();
            }
        }
        ...
        public class MultiPoint : GeoBase
        {
            ...
            public override void WellKnownBinary(Stream sout)
            {
                ...
                foreach (var point in this.Points)
                {
                    ...
                    sout.Write(ipp == IndexesPerPoint.Two ? GeoBase.PointXyWkbs.ToArray() : ipp == IndexesPerPoint.Three ? GeoBase.PointXyzWkbs.ToArray() : GeoBase.PointXyzmWkbs.ToArray(), 0, 4);
            ...
            private byte[] MaxWkbsType()
            {
                ...
                ? GeoBase.MultiPointXyWkbs.ToArray()
                : high == IndexesPerPoint.Three ? GeoBase.MultiPointXyzWkbs.ToArray() : GeoBase.MultiPointXyzmWkbs.ToArray();
            }
        }
        ...
        public class MultiLineString : GeoBase
        {
            ...
            public override void WellKnownBinary(Stream sout)
            {
                ...
                foreach (var lineString in this.LineStrings)
                {
                    ...
                    sout.Write(ipp == IndexesPerPoint.Two ? GeoBase.LineStringXyWkbs.ToArray() : ipp == IndexesPerPoint.Three ? GeoBase.LineStringXyzWkbs.ToArray() : GeoBase.LineStringXyzmWkbs.ToArray(), 0, 4);
            ...
            private byte[] WkbsType()
            {
                if (this.LineStrings.Any())
                {
                    ...
                    ? GeoBase.MultiLineStringXyWkbs.ToArray()
                    : maxIpp == IndexesPerPoint.Three ? GeoBase.MultiLineStringXyzWkbs.ToArray() : GeoBase.MultiLineStringXyzmWkbs.ToArray();
                }

                return GeoBase.MultiLineStringXyWkbs.ToArray();
            }
        }
        ...
        public class MultiPolygon : GeoBase
        {
            ...
            public override void WellKnownBinary(Stream sout)
            {
                ...
                foreach (var polygon in this.Polygons)
                {
                    ...
                    : IndexesPerPoint.Two;
                    sout.Write(ipp == IndexesPerPoint.Two ? GeoBase.PolygonXyWkbs.ToArray() : ipp == IndexesPerPoint.Three ? GeoBase.PolygonXyzWkbs.ToArray() : GeoBase.PolygonXyzmWkbs.ToArray(), 0, 4);
            ...
            private byte[] WkbsType()
            {
                if (this.Polygons.Any())
                {
                    ...
                    return maxIpp == IndexesPerPoint.Two
                    ? GeoBase.MultiPolygonXyWkbs.ToArray()
                    : maxIpp == IndexesPerPoint.Three ? GeoBase.MultiPolygonXyzWkbs.ToArray() : GeoBase.MultiPolygonXyzmWkbs.ToArray();
                }

                return GeoBase.MultiPolygonXyWkbs.ToArray();
            }
        }
        ...
        public class Collection : GeoBase
        {
            ...
            public override void WellKnownBinary(Stream o)
            {
                ...
                o.Write(GeoBase.GeometryCollectionXyWkbs.ToArray(), 0, 4);
            ...
            public override void ParseJson(JArray array)
            {
                ...
                foreach (var elem in array)
                {
                    ...
                    this.Entries.Add(DbGeometryGeoJsonConverter.ParseJsonObjectToGeoBase((JObject)elem, out dummyCoordinateSystem));
                }
            }
        }
    }
