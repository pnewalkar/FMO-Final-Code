namespace RM.CommonLibrary.HelperMiddleware
{
    ...
    {
        public const string NetworkLinkPathLink = "Path Link";
        public const string NetworkLinkRoadLink = "Road Link";
        ...
        public const string AccessLinkDirectionBoth = "Both";

        public const string AccessLinkTypeDefault = "Default";
