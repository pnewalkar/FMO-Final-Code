namespace RM.CommonLibrary.HelperMiddleware
{
    ...
    {
        public const string AccessLinkDirection = "AccessLinkDirection";
        public const string AccessLinkParameters = "AccessLinkParameters";
        public const string AccessLinkStatus = "AccessLinkStatus";
        ...
        public const string NetworkNodeType = "NetworkNodeType";
        public const string NotificationPriority = "NotificationPriority";
        public const string NotificationType = "NotificationType";
        public const string OperationalObjectType = "OperationalObjectType";
