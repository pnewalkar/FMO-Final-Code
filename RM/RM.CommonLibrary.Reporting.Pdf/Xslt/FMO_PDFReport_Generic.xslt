...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
  ...
  <xsl:template match="/report">
    <fo:root>
      <fo:layout-master-set>
        <!-- Page masters for use with headers and footers -->
        ...
        <!-- Page masters for use without headers and footers -->
        <fo:simple-page-master master-name="A4PortraitNoHeaderOrFooter" page-width="210mm" page-height="297mm" margin-top="1cm" margin-bottom="1cm" margin-left="1cm"  margin-right="1cm">
          <fo:region-body margin-top="0cm" margin-bottom="0cm" margin-left="0cm" margin-right="0cm" column-count="1"/>
          <fo:region-before extent="0.5cm"/>
          <fo:region-after extent="0.5cm"/>
          <fo:region-start extent="0.5cm"/>
          <fo:region-end extent="0.5cm"/>
        </fo:simple-page-master>
        <fo:simple-page-master master-name="A4LandscapeNoHeaderOrFooter" page-width="297mm" page-height="210mm" margin-top="1cm" margin-bottom="1cm" margin-left="1cm"  margin-right="1cm">
          <fo:region-body margin-top="0cm" margin-bottom="0cm" margin-left="0cm" margin-right="0cm" column-count="1"/>
          <fo:region-before extent="0.5cm"/>
          <fo:region-after extent="0.5cm"/>
          <fo:region-start extent="0.5cm"/>
        ...
        <fo:simple-page-master master-name="A3PortraitNoHeaderOrFooter" page-width="297mm" page-height="420mm" margin-top="1cm" margin-bottom="1cm" margin-left="1cm"  margin-right="1cm">
          <fo:region-body margin-top="0cm" margin-bottom="0cm" margin-left="0cm" margin-right="0cm" column-count="1"/>
          <fo:region-before extent="0.5cm"/>
          <fo:region-after extent="0.5cm"/>
          <fo:region-start extent="0.5cm"/>
        ...
        <fo:simple-page-master master-name="A3LandscapeNoHeaderOrFooter" page-width="420mm" page-height="297mm" margin-top="1cm" margin-bottom="1cm" margin-left="1cm"  margin-right="1cm">
          <fo:region-body margin-top="0cm" margin-bottom="0cm" margin-left="0cm" margin-right="0cm" column-count="1"/>
          <fo:region-before extent="0.5cm"/>
          <fo:region-after extent="0.5cm"/>
          <fo:region-start extent="0.5cm"/>
        ...
        <fo:simple-page-master master-name="A2PortraitNoHeaderOrFooter" page-width="420mm" page-height="594mm" margin-top="1cm" margin-bottom="1cm" margin-left="1cm"  margin-right="1cm">
          <fo:region-body margin-top="0cm" margin-bottom="0cm" margin-left="0cm" margin-right="0cm" column-count="1"/>
          <fo:region-before extent="0.5cm"/>
          <fo:region-after extent="0.5cm"/>
          <fo:region-start extent="0.5cm"/>
        ...
        <fo:simple-page-master master-name="A2LandscapeNoHeaderOrFooter" page-width="594mm" page-height="420mm" margin-top="1cm" margin-bottom="1cm" margin-left="1cm"  margin-right="1cm">
          <fo:region-body margin-top="0cm" margin-bottom="0cm" margin-left="0cm" margin-right="0cm" column-count="1"/>
          <fo:region-before extent="0.5cm"/>
          <fo:region-after extent="0.5cm"/>
          <fo:region-start extent="0.5cm"/>
        ...
        <fo:simple-page-master master-name="A1PortraitNoHeaderOrFooter" page-width="594mm" page-height="841mm" margin-top="1cm" margin-bottom="1cm" margin-left="1cm"  margin-right="1cm">
          <fo:region-body margin-top="0cm" margin-bottom="0cm" margin-left="0cm" margin-right="0cm" column-count="1"/>
          <fo:region-before extent="0.5cm"/>
          <fo:region-after extent="0.5cm"/>
          <fo:region-start extent="0.5cm"/>
        ...
        <fo:simple-page-master master-name="A1LandscapeNoHeaderOrFooter" page-width="841mm" page-height="594mm" margin-top="1cm" margin-bottom="1cm" margin-left="1cm"  margin-right="1cm">
          <fo:region-body margin-top="0cm" margin-bottom="0cm" margin-left="0cm" margin-right="0cm" column-count="1"/>
          <fo:region-before extent="0.5cm"/>
          <fo:region-after extent="0.5cm"/>
          <fo:region-start extent="0.5cm"/>
        ...
        <fo:simple-page-master master-name="A0PortraitNoHeaderOrFooter" page-width="841mm" page-height="1189mm" margin-top="1cm" margin-bottom="1cm" margin-left="1cm"  margin-right="1cm">
          <fo:region-body margin-top="0cm" margin-bottom="0cm" margin-left="0cm" margin-right="0cm" column-count="1"/>
          <fo:region-before extent="0.5cm"/>
          <fo:region-after extent="0.5cm"/>
          <fo:region-start extent="0.5cm"/>
        ...
        <fo:simple-page-master master-name="A0LandscapeNoHeaderOrFooter" page-width="1189mm" page-height="841mm" margin-top="1cm" margin-bottom="1cm" margin-left="1cm"  margin-right="1cm">
          <fo:region-body margin-top="0cm" margin-bottom="0cm" margin-left="0cm" margin-right="0cm" column-count="1"/>
          <fo:region-before extent="0.5cm"/>
          <fo:region-after extent="0.5cm"/>
          <fo:region-start extent="0.5cm"/>
  ...
  <xsl:template match="caption">
    <fo:block font-size="12pt" space-after="0.2cm">
      <xsl:if test="@align">
