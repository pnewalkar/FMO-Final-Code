...
namespace RM.Data.ThirdPartyAddressLocation.WebAPI.Test.DataService
{
    /// <summary>
    /// This class contains test methods for AddressLocationDataService
    /// </summary>
    [TestFixture]
    public class AddressLocationDataServiceFixture : RepositoryFixtureBase
    {
        ...
        AddressLocationDataDTO addressLocationDataDTO = new AddressLocationDataDTO
        {
            ID = Guid.Empty,
            UDPRN = 1234,
            Lattitude = 10,
