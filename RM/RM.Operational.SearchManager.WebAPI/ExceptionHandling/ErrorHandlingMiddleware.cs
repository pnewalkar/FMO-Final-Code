...
using RM.Operational.SearchManager.WebAPI.ExceptionHandling.ResponseExceptionHandler;

namespace RM.Operational.SearchManager.WebAPI.ExceptionHandling
{
    /// <summary>
    ...
    public class ErrorHandlingMiddleware
    {
        ...
        public async Task Invoke(HttpContext context /* other scoped dependencies */)
        {
            ...
            catch (Exception ex)
            {
                ...
                // if (rethrow) { if (wrappedException == null) { await HandleExceptionAsync(context,
                // ex); } else { await HandleExceptionAsync(context, wrappedException); } } else {
