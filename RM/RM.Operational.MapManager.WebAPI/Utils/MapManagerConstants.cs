namespace RM.Operational.MapManager.WebAPI.Utils
{
    public static class MapManagerConstants
    {
        ...
        internal const string ImagePath = "ImagePath";
        internal const string PrintMapDateTimeFormat = "{0:dd/MM/yyyy HH:mm}";
